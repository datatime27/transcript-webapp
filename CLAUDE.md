...
- `get_version(version_uid)` — returns `(filepath, speakers, user_uid)` for a version; speakers injected into JSON by `transcripts.py`. `user_uid` used to detect cross-user loads for the v2.0 review workflow.
